...
(function() {
  ...
  pb.get_extension = function() {
    ...
    if (pb.browser.name === "Chrome") {
      if ((typeof chrome !== "undefined" && chrome !== null) && (chrome.webstore != null)) {
        try {
          chrome.webstore.install(pb.URLS.chrome, function(msg) {
            return track("extention_installed", {
              message: msg
            });
          }, function(msg) {
            track("extentions_install_fail", {
              message: msg
            });
            return new_tab(pb.URLS.chrome);
          });
        } catch (error) {
    ...
    AccountApiSuite.prototype.downgrade_pro = function() {
      return pb.net.post('/v3/downgrade-pro', {}, function(r) {
        if (r.error) {
          ...
          return pb.pro.downgrade_msg = "Sorry, cancelling Pro failed. Please try again or email us at contact@pushbullet.com";
        } else {
          track("pro_downgrade");
          return pb.pro.downgrade_msg = "Pro canceled successfully. Your card will not be charged again.";
        }
      });
    };
...
// Generated by CoffeeScript 1.10.0
(function() {
  var api_key_form, connected_accounts, delete_account_flag, delete_account_form, delete_all_pushes, delete_pushes_flag, downgrading, draw_account, pro_section, reset_api_key_flag, sub_tab;
...
// Generated by CoffeeScript 1.10.0
(function() {
  var card, card_mobile, compair, downgrading, fancy_footer, features, line_color, paypal_approval, paypal_button, paypal_click, place, plan_card, pushbullet_pro_bar, refund_policy, section_heading, stripe_button, stripe_click, stripe_mobile_button, stripe_popup, switcher, switcher_mobile, twinkles;
  ...
  views.pro_page = function() {
    ...
    div("#pro-card", function() {
      var ref;
      if (pb.pro.downgrade_msg) {
        return div(function() {
          padding("100px 20px");
          text_align('center');
          return div(function() {
            padding_bottom(30);
            return text(pb.pro.downgrade_msg);
          });
        });
