...
let createBuildConfiguration = function(platform) {
    ...
    return {
        ...
        'win32metadata': {
            ...
            FileVersion: options.productVersion,
            ProductVersion: options.productVersion,
            ProductName: productName,
...
let packageArtifact = function(platformName, sourceArtifact, targetDirectory, buildOptions, callback) {
    ...
    platformPackager.darwin = function() {
        let architectureName = parseArchitecture(sourceArtifact),
            targetFileName = getSafePackageFileName(buildOptions['name'], buildOptions['productVersion'], architectureName, null, true),
    ...
    platformPackager.win32 = function() {
        let architectureName = parseArchitecture(sourceArtifact),
            targetFileName = getSafePackageFileName(buildOptions['productName'], buildOptions['productVersion'], architectureName),
            targetSubdirectory = path.join(targetDirectory, targetFileName),
            targetExtension = '.exe',
        ...
        let deployOptions = {
            ...
            version: buildOptions['productVersion'],
    ...
    platformPackager.linux = function() {
        ...
        let deployOptions = {
            ...
            rename: function(dest) {
                ...
                let filename = getSafePackageFileName(buildOptions['name'] + targetExtension, buildOptions['productVersion'], architectureName);
